            ...
            <div class="nano">
                <div class="nano-content sidebar-nav">
                    ...
                    <ul class="metisMenu nav flex-column" id="menu">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="patrimoine" aria-expanded="false"><i class="fa fa-tasks"></i> <span class="toggle-none">Vehicules</a> 
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="service" aria-expanded="false"><i class="fa fa-tasks"></i> <span class="toggle-none">Services</a> 
                        </li>						
