...
<head>
        ...
        <title>Rapport des presence</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-default">
                          Liste des presences de tout les presences
...
<?php
 ...
 $requete=$db->query("SELECT * FROM tbl_agent LEFT JOIN attendance ON tbl_agent.STUDENTID=attendance.STUDENTID ORDER BY TIMEOUT DESC"); ?>
