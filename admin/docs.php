...
<head>
    ...
    if(isset($_POST['submit'])){
        ...
        if($run){
            ...
            Swal.fire({
                position: 'top-end',
                icon: 'success',
                title: 'Fichier soumis avec success',
   ...
   <?php 
                        ...
                        $service = $db->query('SELECT * FROM dossier INNER JOIN tbl_agent ON dossier.id_user=tbl_agent.id_utilisateur');
