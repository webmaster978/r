...
<?php $requete=$db->query("SELECT * FROM tbl_agent"); ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <div class="modal-body">
        <input type="hidden" name="id_utilisateur" value="<?= $g['id_utilisateur']; ?>">
        <h2>Etes vous sur de vouloir supprimer <?= $g['nom_complet']; ?> ??? </h2>
      </div>
      <div class="modal-footer">
...
<button type="button" class="btn btn btn-danger" data-toggle="modal" data-target="#exampleM<?= $g['id_utilisateur']; ?>">
