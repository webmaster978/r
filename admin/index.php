                    ...
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5">Connecter</h2>
								<p class="text-muted">Personne connecter</p>
                    ...
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								...
								<p class="text-muted">Total Totalutilisateurs</p>
								<?php

$u = $db->query("SELECT COUNT(*) AS id_authentification FROM authentification"); 
?>
<?php while ($uu= $u->fetch())  {?>
								<span class="float-right text-indigo widget-r-m"><?=$uu['id_authentification'];?></span>
							</div>
							<div class="progress margin-b-10 progress-mini">
								<div style="width:<?=$uu['id_authentification'];?>%;" class="progress-bar bg-indigo"></div>
							</div>
							<?php } ?>
							<!-- <p class="text-muted float-left margin-b-0">Change</p>
				...
				<div class="col-md-3">
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5">Acces</h2>
								<p class="text-muted">Total access</p>
									
								<span class="float-right text-success widget-r-m">4</span>
							</div>
							<div class="progress margin-b-10 progress-mini">
								<div style="width:5%;" class="progress-bar bg-success"></div>
							</div>
