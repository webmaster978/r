...
if (isset($_POST['submit'])) {
  ...
  $req=$db->prepare("INSERT INTO taches (agent,nom_tache,temp_1,temp_2,mandataire) VALUES (:agent,:nom_tache,:temp_1,:temp_2,:mandataire)");

  $res=$req->execute(array(
    'nom_tache' => htmlspecialchars($_POST['nom_tache']),
    'temp_1' => htmlspecialchars($_POST['temp_1']),
    'temp_2' => htmlspecialchars($_POST['temp_2']),
    'mandataire' => htmlspecialchars($_POST['mandataire']),
    
    'agent' => $_SESSION['PROFILE']['nom_complet']
  ));
  if ($res) {
     echo "<script>
     Swal.fire({
