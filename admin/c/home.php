	...
	<div class="row mt-3 ml-3 mr-3">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="card bg-warning">
								<div class="card-body text-white">
									<p><b><large>Total ventes journaliere</large></b></p>
									<hr>
						...
						<div class="col-sm-4">
							<div class="card bg-success">
								<div class="card-body text-white">
									<p><b><large>Total transaction</large></b></p>
									<hr>
									<p class="text-right"><b><large><?php 
									include 'db_connect.php';
			...
			<div class="row">
				<div class="col-md-8">
					<div class="card">
						<div class="card-body">
						<?php echo "Bienvenue ".$_SESSION['login_name']."!"  ?>				
						</div>
						<hr>
					</div>
				</div>
							...
							<div class="container-fluid">
								<ul class="list-group">
									...
									<li class="list-group-item bg-danger text-white">
										...
										<hr>
										<a href="index.php?page=manage_expired&iid=<?php echo $row['id'] ?>" class="btn badge badge-primary float-right">Confirmer</a>
									</li>
									<?php endwhile; ?>
								</ul>
							</div>			
