...
<!--end modaluser-->
 ...
 <div id="loader"></div>
      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <div class="d-flex justify-content-center pull-right">
            ...
            <a href="add_document">
            <button class="btn btn-warning"><i class="far fa-file-image"></i>  Voir les fichiers</button></a>
        </div>
      </div>
      <hr>
    <div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Ajouter un nouveau fichier</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row"><br><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
           ...
           <label for="subject" class="">Importer</label>
          <input type="file" name="myfile"> <br>
          <button  type="submit" class="btn btn-info btn-rounded btn-block my-4 waves-effect z-depth-0"  name="save" type="submit">Importer</button>
         <footer style="font-size: 12px"><b>Type des fichiers :</b><font color="red"><i>.docx .doc .pptx .ppt .xlsx .xls .pdf .odt</i></font></footer>
        </form>
      </div>
    </div>
  </div>
