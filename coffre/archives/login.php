    ...
    <div class="card-body">
        ...
        <form action="userlogin/login.php" method="POST">
            ...
            <div class="text-center py-4 mt-3">
                <button class="btn btn-default btn-lg btn-block" name = "logIn" id="login" type="submit">Se connecter</button>
            </div>
...
<!-- Card --></div>
       <footer class="text-center py-4 mt-3" style="background-color: #c6ecef;margin-left: 30%;margin-right: 30%;border-radius:4px;    margin-bottom: 5px;">
                <p>All right Reserved 2021&copy; <?php echo date('Y');?> UNIGOM-RH-MANAGER</p>
            </footer>
<!-- Card -->
  <!-- /Start your project here-->
