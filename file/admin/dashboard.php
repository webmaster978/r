    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
     ...
     require_once("include/connection.php");
          ...
          <ul class="navbar-nav nav-flex-icons">
                  <li style="margin-top: 10px;">Bienvenues,</font> <?php echo ucwords(htmlentities($id)); ?></li>
            <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold"><i class="fas fa-user-plus"></i> Ajouter Admin</h4>
...
<!-- 
    ...
    <p>All right Reserved &copy; <?php echo date('Y');?> by UNIGOM RH-MANAGER</p>
    </div>
    <!--/.Copyright-->
