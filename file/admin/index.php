...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark lighten-1">
    <a class="navbar-brand" href="login"><img src="../img/L.png" width="33px" height="33px"> Coffre fort unigom</a>
    ...
    <div class="card-body">
        ...
        <form action="admin_login.php" method="POST">
            ...
            <div class="md-form">
                ...
                <label for="materialFormCardEmailEx" class="font-weight-light">Adresse mail</label>
            </div>
            ...
            <div class="text-center py-4 mt-3">
                <button class="btn btn-primary btn-lg btn-block" name ="adminlog" id="login" type="submit">Se connecter</button>
            </div>
...
<!-- Card --></div>
       <footer class="text-center py-4 mt-3" style="background-color: rgb(206, 209, 154);margin-left: 30%;margin-right: 30%;border-radius:4px;    margin-bottom: 5px;">
                <p>All right Reserved 2021&copy; <?php echo date('Y');?> Coffre fort UNIGOM</p>
            </footer>
<!-- Card -->
  <!-- /Start your project here-->
