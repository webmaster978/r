...
function BasicTable()
{
	...
	$req=$db->query('SELECT * FROM abonne INNER JOIN login ON abonne.idc=login.id');
	// $this->Cell(200,10,'Nos clients',1,0,'C');
		...
		$this->Cell(30,10,'Utilisateur',1,0,'C');
	...
	while ($row = $req->fetch(PDO::FETCH_OBJ)) {
		...
		$this->Cell(50,8,$row->nom,1,0,'C');
		$this->Cell(40,8,$row->adresse,1,0,'C');
