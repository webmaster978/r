            ...
            <div class="row w-no-padding margin-b-30">
                    ...
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5">Produit</h2>
								<p class="text-muted">Total Product</p>
								<span class="float-right text-primary widget-r-m">16</span>
							</div>
                ...
                <div class="col-md-3">
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5"> Retrait</h2>
								<p class="text-muted">Total retrait</p>
								<span class="float-right text-indigo widget-r-m">10</span>
							</div>
							<div class="progress margin-b-10 progress-mini">
				...
				<div class="col-md-3">
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5">Expirer</h2>
								<p class="text-muted">Total produit expirer</p>
				...
				<div class="col-md-3">
                    <div class="widget  bg-light">
                        <div class="row row-table ">
                            <div class="margin-b-30">
								<h2 class="margin-b-5">demandes</h2>
								<p class="text-muted">Total demande</p>
