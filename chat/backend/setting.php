    		...
    		if(in_array($img_type, $types) === true)
    		{
    			if($image_size <= 2000000)
    			{
    				if($width == '225' && $height == '225')
    				{
		    			...
		    			{
		    				$error .= '<li>Impossible d importer une photo</li>';
		    			}
		    		}
		    		else
		    		{
		    			$error .= '<li>La taille recommander est 225 X 225</li>';
		    		}
	    		}
	    		else
	    		{
	    			$error .= '<li>la capaciter normale est de 2MB</li>';
	    		}
    		}
    		else
    		{
    			$error .= '<li>Image invalide</li>';
    		}
    	}
    	else
    	{
